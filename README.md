...
SuperHyde is a brazen two-column, autohide sidebar theme based on the [hyde](http://hyde.spf13.com) theme by spf13.
It pairs a prominent sidebar with uncomplicated content.

![SuperHyde screenshot]()
...
To install SuperHyde as your default theme, first install this repository in the `themes/` directory:

    $ cd themes/
    $ git clone https://github.com/ageekymonk/hugo-superhyde-theme.git
